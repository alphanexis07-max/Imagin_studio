  ...
  portfolio: {
    ...
    sections: {
      ...
      visualAssets: {
        ...
        description: "Crafting Unforgettable Visual Systems.",
      },
      softwareSystems: {
        eyebrow: "Automation & Workflows",
        title: "SOFTWARE & SYSTEMS",
        description: "Automating Workflows ,Accelerating Results, and Scaling Operations.",
      },
      seoAnalytics: {
        eyebrow: "Attention & Engagement",
        title: "Social Media & Marketing ",
        description: "Turning engagement into action.",
      },
      strategicConsulting: {
        eyebrow: "Scaled Acquisition",
        title: "Performance Marketing",
        description: "Trurning Ad spent into Profit.",
      },
      contentWriting: {
        eyebrow: "Copywriting",
